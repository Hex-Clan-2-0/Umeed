      ...
      <div class="page">
        <div class="container">
          ...
          <div class="nav-btn-slide ">
            <ul>
              <li>
                <a class="" href="/p/pendingRequest">
                  Pending Request
                </a>
              </li>
              <li>
                <a class="" href="/p/doctorList">
                  NGO's List
                </a>
              </li>
              <li>
          ...
          <div class="div1Wrapper">
            <div class="div1">
              ...
              <div className="common" id="option5">
                <i class="fas fa-hourglass-start"></i>Pending Request
              </div>
              <div className="common" id="option7">
                <i class="fas fa-user-md"></i>NGOs
              </div>
              <div className="common" id="option6">
            ...
            <div class="second">
              <div class="wrap">
                <div class="mainprofile">
                  ...
                  <div class="profilePic">{/* <img src={Image}/> */}</div>
                </div>
              </div>
            </div>
...
>>>>>>> 2cc0d853790826762d8debcdf878da1555a39e39
}
