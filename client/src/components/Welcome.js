        ...
        <div class={style.container}>
            ...
            <div class={style.div1Wrapper}>
                <div class={style.div1}>
                    ...
                    <div className={style.common} id={style.option5}><i class={'${fas}, ${fa-hourglass-start}'}></i>Pending Request</div>
                    <div className={style.common} id={style.option7}><i class={'${fas}, ${fa-user-md}'}></i>NGOs</div>
                    <div className={style.common} id={style.option6}><i class={'${fas}, ${fa-sign-out-alt}'}></i>Logout</div>
